      ...
      <table className="min-w-full border">
        <thead>
          <tr>
            ...
            <th className="border px-4 py-2">Issue Qty</th>
...
//   return (
//     <div className="container mx-auto p-4">
//       <h2 className="row-span-1 text-6xl text-center text-teal-500 font-bold">Prescription Issue</h2>
//       <h1 className="text-2xl font-bold mb-4">Medicine's Table</h1>
//       <table className="min-w-full bg-white">
//         <thead>
//           <tr>
//             <th className="py-2 px-4 border-b">Material Name</th>
//             <th className="py-2 px-4 border-b">Oder Quantity</th>
